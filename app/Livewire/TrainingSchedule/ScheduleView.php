...
class ScheduleView extends Component
{
    ...
    public function exportPdf()
    {
        ...
        $schedulesQuery = TrainingSchedule::with(['team.category', 'team.section', 'team.coaches', 'team.players', 'trainingField'])
        ...
        // Renderizar la vista blade para el PDF
        $html = view('pdfs.training-schedules', [
            'season' => $season,
