...
class Edit extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->is_completed = $session->is_completed;
        ...
        foreach ($session->sessionExercises as $sessionExercise) {
            $this->exercises[] = [
                ...
                'title' => $sessionExercise->isCustom() ? $sessionExercise->custom_title : $sessionExercise->exercise->title,
                'description' => $sessionExercise->isCustom() ? $sessionExercise->custom_description : $sessionExercise->exercise->description,
                'duration_minutes' => $sessionExercise->duration_minutes,
                'recommended_players' => $sessionExercise->recommended_players,
                'difficulty' => $sessionExercise->exercise->difficulty ?? null,
    ...
    public function save()
    {
        ...
        session()->flash('message', 'Sesión de entrenamiento actualizada correctamente.');
    ...
    public function render()
    {
        ...
        return view('livewire.training-sessions.edit', [
            'teams' => $teams,
