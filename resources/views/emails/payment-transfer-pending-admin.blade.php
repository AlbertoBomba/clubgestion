...
<title>Transferencia pendiente de validar</title>
</head>
@php
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, {{ $primary }} 0%, {{ $secondary }} 100%); padding:32px 24px; text-align:center;">
                            ...
                            <h1 style="margin:0; color:#ffffff; font-size:22px; font-weight:700; line-height:1.3;">
                                Nueva transferencia pendiente de validar
                            </h1>
                    ...
                    <tr>
                        <td style="padding:32px 32px 16px 32px;">
                            ...
                            <p style="margin:0 0 20px 0; font-size:15px; line-height:1.6; color:#374151;">
                                Un jugador ha marcado como <strong>pagada por transferencia</strong> una carta de pago y ha adjuntado el justificante. Queda <strong>pendiente de validar</strong> desde el panel de administración.
                            </p>
                                    ...
                                    <td style="padding:0 20px 12px 20px;">
                                        ...
                                        <div style="font-size:15px; color:#111827; margin-top:4px;">
                                            ...
                                            @if($player && $player->email)
                                                <br><span style="color:#6b7280; font-size:13px;">{{ $player->email }}</span>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <p style="margin:20px 0 0 0; font-size:13px; line-height:1.6; color:#6b7280;">
                                Encontrarás el justificante adjunto a este correo. Cuando confirmes la transferencia en el banco, marca el recibo como pagado desde el panel de cartas de pago.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:16px 32px 28px 32px; border-top:1px solid #e5e7eb;">
                            <p style="margin:0; font-size:12px; color:#9ca3af; text-align:center;">
                                Aviso automático del portal público de {{ $schoolName }}.
                            </p>
                        </td>
                    </tr>
                </table>
