        ...
        <div class="space-y-6">
            ...
            <div class="bg-gray-50 p-4 rounded-xl">
                ...
                <div>
                    @if($currentImage)
                        <div class="mb-4">
                            <p class="text-sm font-semibold text-titanium mb-2">Imagen actual:</p>
                            <img src="{{ Storage::url($currentImage) }}" class="w-32 h-32 object-cover rounded-lg border border-silver">
                        </div>
                    @endif
                    
                    <label class="block text-sm font-semibold text-titanium mb-2">
                        {{ $currentImage ? 'Cambiar imagen' : 'Imagen del producto' }}
                    </label>
                    ...
                    @if ($image)
                        <div class="mt-3">
                            <p class="text-sm text-gray-600 mb-2">Nueva imagen (vista previa):</p>
            ...
            <div class="bg-gray-50 p-4 rounded-xl">
                ...
                @if($existingMedia && count($existingMedia) > 0)
                    <div class="mb-4">
                        <p class="text-sm font-semibold text-titanium mb-2">Archivos actuales:</p>
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                            @foreach($existingMedia as $media)
                                <div class="relative group">
                                    @if($media->type === 'video')
                                        <video src="{{ Storage::url($media->file_path) }}" class="w-full h-32 object-cover rounded-lg border border-silver" controls></video>
                                    @else
                                        <img src="{{ Storage::url($media->file_path) }}" class="w-full h-32 object-cover rounded-lg border border-silver">
                                    @endif
                                    ...
                                    <span class="absolute bottom-1 left-1 bg-black bg-opacity-60 text-white text-xs px-2 py-1 rounded">
                ...
                <div>
                    <label class="block text-sm font-semibold text-titanium mb-2">Agregar más archivos</label>
