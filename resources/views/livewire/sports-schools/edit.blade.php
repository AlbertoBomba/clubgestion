        ...
        <form wire:submit.prevent="save" class="space-y-6">
            <div class="space-y-4">
                ...
                <div>
                    ...
                    @if ($currentLogo)
                        <div class="mb-4 flex items-center space-x-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                            <img src="{{ Storage::url($currentLogo) }}" alt="Logo actual" class="h-20 w-20 object-contain rounded-lg border border-gray-300 bg-white p-2">
                            <div class="flex-1">
                                <p class="text-sm text-gray-700 font-medium">Logo actual</p>
                                <button type="button" wire:click="deleteLogo" 
                                    class="mt-2 text-xs text-red-600 hover:text-red-800 font-semibold flex items-center">
                    ...
                    @if ($logo)
                        <div class="mb-4 p-4 bg-green-50 rounded-xl border border-green-200">
                            <p class="text-sm text-green-700 font-medium flex items-center">
                                ...
                                Nuevo logo seleccionado: {{ $logo->getClientOriginalName() }}
                            </p>
