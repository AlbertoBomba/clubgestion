<div>
    <div class="card-modern bg-white rounded-2xl shadow-xl border border-purple-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100 bg-gradient-to-r from-purple-50 to-blue-50">
            ...
            <p class="text-sm text-gray-600 mt-1">Actualiza la información del usuario</p>
        </div>

        <form wire:submit="save" class="p-6 space-y-6">
            <!-- Información Básica -->
            <div class="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input wire:model="name" type="text" id="name" 
                            class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900 @error('name') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input wire:model="email" type="email" id="email" 
                            class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900 @error('email') border-red-500 @enderror">
            ...
            <!-- Cambiar Contraseña -->
            <div class="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-6 space-y-4">
                <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                ...
                <p class="text-xs text-gray-600">Deja en blanco si no deseas cambiar la contraseña</p>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700 mb-2">Nueva contraseña</label>
                        <input wire:model="password" type="password" id="password" 
                            class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900 @error('password') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input wire:model="password_confirmation" type="password" id="password_confirmation" 
                            class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900">
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select wire:model="sports_school_id" id="sports_school_id" 
                            class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900 @error('sports_school_id') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <select wire:model="role" id="role" 
                            class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900 @error('role') border-red-500 @enderror"
            ...
            <div class="flex items-center space-x-3">
                <label for="is_active" class="flex items-center cursor-pointer">
                    <div class="relative">
                        ...
                        <div class="block bg-gray-300 w-14 h-8 rounded-full" :class="{ 'bg-gradient-to-r from-green-500 to-emerald-600': checked }"></div>
