        ...
        <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                        @foreach($existingMedia as $media)
                            <div class="relative">
                                ...
                                @else
                                    <div class="w-full h-32 bg-gray-100 rounded-lg border-2 border-gray-300 flex items-center justify-center">
                ...
                @if(count($newImages) > 0)
                    <div class="mb-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                        @foreach($newImages as $index => $image)
                            <div class="relative">
                                <img src="{{ $image->temporaryUrl() }}" class="w-full h-32 object-cover rounded-lg border-2 border-green-300">
                                <button type="button" 
            ...
            <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                ...
                <button type="submit" 
                    ...
                    <span wire:loading.remove wire:target="save">Actualizar Entrenamiento</span>
