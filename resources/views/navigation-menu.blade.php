<nav x-data="{ open: false, sidebarOpen: false }" class="glass-effect border-b border-primary/10 shadow-lg sticky top-0 z-50">
            ...
            <div class="flex w-full sm:w-auto justify-between sm:justify-start">
                ...
                @if(auth()->user()->hasRole('master') && !auth()->user()->sportsSchool)
                    <div class="hidden space-x-2 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <a href="{{ route('sizes.index') }}" class="sidebar-link inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('sizes.*') ? 'active text-white-pure' : 'text-titanium' }}">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('product-categories.index') }}" class="sidebar-link inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('product-categories.*') ? 'active text-white-pure' : 'text-titanium' }}">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('products.index') }}" class="sidebar-link inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('products.*') ? 'active text-white-pure' : 'text-titanium' }}">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('exercises.index') }}" class="sidebar-link inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('exercises.*') ? 'active text-white-pure' : 'text-titanium' }}">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('training-sessions.index') }}" class="sidebar-link inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('training-sessions.*') ? 'active text-white-pure' : 'text-titanium' }}">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('api-logs.index') }}" class="sidebar-link inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('api-logs.*') ? 'active text-white-pure' : 'text-titanium' }}">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            API Logs
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-white-pure/95 backdrop-blur-lg border-t border-primary/10">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->hasRole('master') || session()->has('impersonator_id'))
                ...
                <a href="{{ route('api-logs.index') }}" class="sidebar-link block pl-3 pr-4 py-2 text-base font-medium {{ request()->routeIs('api-logs.*') ? 'active text-white-pure' : 'text-titanium' }}">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @elseif(auth()->user()->sportsSchool && !session()->has('impersonator_id'))
                ...
                <a href="{{ route('sizes.index') }}" class="sidebar-link block pl-3 pr-4 py-2 text-base font-medium {{ request()->routeIs('sizes.*') ? 'active text-white-pure' : 'text-titanium' }}">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                        </svg>
                ...
                <a href="{{ route('product-categories.index') }}" class="sidebar-link block pl-3 pr-4 py-2 text-base font-medium {{ request()->routeIs('product-categories.*') ? 'active text-white-pure' : 'text-titanium' }}">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"/>
                        </svg>
                ...
                <a href="{{ route('products.index') }}" class="sidebar-link block pl-3 pr-4 py-2 text-base font-medium {{ request()->routeIs('products.*') ? 'active text-white-pure' : 'text-titanium' }}">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                        </svg>
                ...
                @if(auth()->user()->hasAnyRole(['school_admin', 'coach']))
                    <a href="{{ route('teams.index') }}" class="sidebar-link block pl-3 pr-4 py-2 text-base font-medium {{ request()->routeIs('teams.*') ? 'active text-white-pure' : 'text-titanium' }}">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                ...
                @if(auth()->user()->hasRole('school_admin'))
                <a href="{{ route('pay-orders.index') }}" class="sidebar-link block pl-3 pr-4 py-2 text-base font-medium {{ request()->routeIs('pay-orders.*') ? 'active text-white-pure' : 'text-titanium' }}">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                ...
                @if(auth()->user()->hasRole('school_admin'))
                <a href="{{ route('payment-statistics.index') }}" class="sidebar-link block pl-3 pr-4 py-2 text-base font-medium {{ request()->routeIs('payment-statistics.*') ? 'active text-white-pure' : 'text-titanium' }}">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('training-schedule.view') }}" class="sidebar-link block pl-3 pr-4 py-2 text-base font-medium {{ request()->routeIs('training-schedule.view') ? 'active text-white-pure' : 'text-titanium' }}">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    @if(auth()->user()->sportsSchool)
        ...
        <div x-show="sidebarOpen"
            ...
            <!-- Sidebar Menu Items -->
            <nav class="p-4 space-y-2 flex-1 overflow-y-auto" x-data="{ openMenu: null }">
                ...
                <div class="space-y-1">
                    <button @click="openMenu = openMenu === 'gestion' ? null : 'gestion'" 
                            ...
                            :class="{'bg-primary/10 text-primary font-semibold': openMenu === 'gestion'}">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                            </svg>
                            <span>Gestión Escuela</span>
                        </div>
                        <svg class="w-4 h-4 transition-transform duration-200" 
                             :class="{'rotate-180': openMenu === 'gestion'}"
                             fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    </button>
                    
                    <div x-show="openMenu === 'gestion'" 
                         x-transition:enter="transition ease-out duration-200"
                         x-transition:enter-start="opacity-0 transform -translate-y-2"
                         x-transition:enter-end="opacity-100 transform translate-y-0"
                         class="pl-4 space-y-1">

                         @if(auth()->user()->hasAnyRole(['school_admin']))
                            <a href="{{ route('seasons.index') }}" class="sidebar-link block pl-3 pr-4 py-2 text-base font-medium {{ request()->routeIs('seasons.*') ? 'active text-white-pure' : 'text-titanium' }}">
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        ...
                        <a href="{{ route('players.index') }}" 
                           @click="sidebarOpen = false"
                           class="flex items-center px-4 py-2 text-sm text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('players.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                        ...
                        <a href="{{ route('teams.index') }}" 
                           @click="sidebarOpen = false"
                           class="flex items-center px-4 py-2 text-sm text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('teams.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            Equipos
                        ...
                        <a href="{{ route('training-schedule.view') }}" 
                           @click="sidebarOpen = false"
                           class="flex items-center px-4 py-2 text-sm text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('training-schedule.view') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                            </svg>
                ...
                <div class="space-y-1">
                    <button @click="openMenu = openMenu === 'tesoreria' ? null : 'tesoreria'" 
                            class="flex items-center justify-between w-full px-4 py-3 text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200"
                            :class="{'bg-primary/10 text-primary font-semibold': openMenu === 'tesoreria'}">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/>
                            </svg>
                        ...
                        <svg class="w-4 h-4 transition-transform duration-200" 
                             :class="{'rotate-180': openMenu === 'tesoreria'}"
                             fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    </button>
                    
                    <div x-show="openMenu === 'tesoreria'" 
                         x-transition:enter="transition ease-out duration-200"
                         x-transition:enter-start="opacity-0 transform -translate-y-2"
                         x-transition:enter-end="opacity-100 transform translate-y-0"
                         class="pl-4 space-y-1">
                        <a href="{{ route('payments-teams.index') }}" 
                           @click="sidebarOpen = false"
                           class="flex items-center px-4 py-2 text-sm text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('payments-teams.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('pay-orders.index') }}" 
                           @click="sidebarOpen = false"
                           class="flex items-center px-4 py-2 text-sm text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('pay-orders.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            Cartas de pago
                        ...
                        <a href="{{ route('payment-statistics.index') }}" 
                           @click="sidebarOpen = false"
                           class="flex items-center px-4 py-2 text-sm text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('payment-statistics.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                            </svg>
                            Estadísticas
                ...
                <div class="space-y-1">
                    ...
                    <div x-show="openMenu === 'entrenador'" 
                        ...
                        <a href="{{ route('exercises.index') }}" 
                           @click="sidebarOpen = false"
                           class="flex items-center px-4 py-2 text-sm text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('exercises.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                            </svg>
                            Ejercicios
                        ...
                        <a href="{{ route('training-sessions.index') }}" 
                           @click="sidebarOpen = false"
                           class="flex items-center px-4 py-2 text-sm text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('training-sessions.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            Sesiones de entrenamiento
                ...
                <!-- Menú: Configuración -->
                <div class="space-y-1">
                    <button @click="openMenu = openMenu === 'configuracion' ? null : 'configuracion'" 
                            class="flex items-center justify-between w-full px-4 py-3 text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200"
                            :class="{'bg-primary/10 text-primary font-semibold': openMenu === 'configuracion'}">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <svg class="w-4 h-4 transition-transform duration-200" 
                             :class="{'rotate-180': openMenu === 'configuracion'}"
                             fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    </button>
                    
                    <div x-show="openMenu === 'configuracion'" 
                         x-transition:enter="transition ease-out duration-200"
                         x-transition:enter-start="opacity-0 transform -translate-y-2"
                         x-transition:enter-end="opacity-100 transform translate-y-0"
                         class="pl-4 space-y-1">

                        <a href="{{ route('sports-schools.edit', ['school' => auth()->user()]) }}"
                           @click="sidebarOpen = false"
                           class="flex items-center px-4 py-2 text-sm text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('sports-schools.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                            </svg>
                            Club
                         ...
                         <a href="{{ route('my-school-users.index', ['filterSchool' => auth()->user()->sports_school_id]) }}" 
                           @click="sidebarOpen = false"
                           class="flex items-center px-4 py-2 text-sm text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('my-school-users.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                            </svg>
                            Usuarios
                        ...
                        <a href="{{ route('categories.index') }}" 
                           @click="sidebarOpen = false"
                           class="flex items-center px-4 py-2 text-sm text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('categories.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                            </svg>
                            Categorías
                ...
                <div class="space-y-1">
                    ...
                    <div x-show="openMenu === 'gestion_web'" 
                        ...
                        <a href="{{ route('web-home-config.edit') }}" 
                           @click="sidebarOpen = false"
                           class="flex items-center px-4 py-2 text-sm text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('web-home-config.*') || request()->routeIs('web-home-slides.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                            </svg>
                ...
                <a href="{{ route('sizes.index') }}" 
                   @click="sidebarOpen = false"
                   class="flex items-center px-4 py-3 text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('sizes.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                    </svg>
                    Tallas
                ...
                <a href="{{ route('product-categories.index') }}" 
                   @click="sidebarOpen = false"
                   class="flex items-center px-4 py-3 text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('product-categories.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"/>
                    </svg>
                    Categorías
                ...
                <a href="{{ route('products.index') }}" 
                   @click="sidebarOpen = false"
                   class="flex items-center px-4 py-3 text-titanium hover:bg-primary/5 rounded-lg transition-colors duration-200 {{ request()->routeIs('products.*') ? 'bg-primary/10 text-primary font-semibold' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                    </svg>
                    Productos
